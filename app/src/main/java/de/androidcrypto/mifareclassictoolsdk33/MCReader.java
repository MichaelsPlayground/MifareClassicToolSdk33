...
import de.androidcrypto.mifareclassictoolsdk33.Activities.Preferences;
    ...
    public int buildNextKeyMapPart() {
        ...
        if (mKeysWithOrder != null && mLastSector != -1) {
            ...
            boolean retryAuth = Common.getPreferences().getBoolean(
                    Preferences.Preference.UseRetryAuthentication.toString(), false);
            int retryAuthCount = Common.getPreferences().getInt(
                    Preferences.Preference.RetryAuthenticationCount.toString(), 1);
