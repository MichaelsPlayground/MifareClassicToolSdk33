...
import de.androidcrypto.mifareclassictoolsdk33.Common;
import de.androidcrypto.mifareclassictoolsdk33.R;
...
public class AccessConditionDecoder extends BasicActivity {
    ...
    private void addBlockAC(byte[][] acMatrix, boolean hasMoreThan4Blocks) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            read.setText(getColoredPermissionText(c1, c2, c3,
                    Common.Operation.Read, false, isKeyBReadable));
            write.setText(getColoredPermissionText(c1, c2, c3,
                    Common.Operation.Write, false, isKeyBReadable));
            incr.setText(getColoredPermissionText(c1, c2, c3,
                    Common.Operation.Increment, false, isKeyBReadable));
            decr.setText(getColoredPermissionText(c1, c2, c3,
                    Common.Operation.DecTransRest, false, isKeyBReadable));
     ...
     * {@link Common#getOperationRequirements(byte, byte, byte, Common.Operation,
    ...
    private SpannableString getColoredPermissionText(byte c1, byte c2, byte c3,
                                                     Common.Operation op, boolean isSectorTrailer,
