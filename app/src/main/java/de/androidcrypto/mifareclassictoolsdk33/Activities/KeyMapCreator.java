...
import de.androidcrypto.mifareclassictoolsdk33.MCReader;
...
//            "de.syss.MifareClassicTool.Activity.KEY_MAP";
     ...
     * ones if {@link Preferences.Preference#SaveLastUsedKeyFiles} is enabled.
     */
    @Override
    public void onStart() {
        super.onStart();
        ...
        boolean selectLastUsedKeyFiles = Common.getPreferences().getBoolean(
                Preferences.Preference.SaveLastUsedKeyFiles.toString(), true);
     ...
     * If {@link Preferences.Preference#SaveLastUsedKeyFiles} is active, this will also
